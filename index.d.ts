...
declare namespace tuiImageEditor {
  ...
  interface IShapeFilterOption {}

  interface IShapeFillOption {
    type?: string;
    filter?: IShapeFilterOption [];
    color?: string[];
  }
  ...
  class ImageEditor {
    ...
    public startDrawingMode(mode: string, option?: { width?: number; color?: string, arrowType?: { tail?: string, head?: string } }): boolean;
